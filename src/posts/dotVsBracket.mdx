...
```
This should give you the name of Ahsoka's homeworld, Shili! Try this 

📌 Take note of the syntax when calling on a variable to do the work of the accessor -- you don't need quotations `" "`! JavaScript knows that in this example, mysteryPlanet is a variable, and it's not looking for a matching key in the JediOne object.
